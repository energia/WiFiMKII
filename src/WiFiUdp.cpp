...
int WiFiUDP::parsePacket()
{
    ...
    SL_SOCKET_FD_ZERO(&readSocketHandles);
    SL_SOCKET_FD_ZERO(&errorSocketHandles);
    SL_SOCKET_FD_SET(socketHandle, &readSocketHandles);
    SL_SOCKET_FD_SET(socketHandle, &errorSocketHandles);
